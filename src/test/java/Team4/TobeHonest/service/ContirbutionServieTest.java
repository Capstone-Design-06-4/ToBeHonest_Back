...
@Transactional
public class ContirbutionServieTest {
    @Autowired
    ...
    public void setUp() throws Exception {
        ...
        memberService.join(joinDTO);
        em.flush();
        List<Item> 아이폰 = itemRepository.searchItemName("아이폰");
        Item item = 아이폰.get(0);
    ...
    public void testFunding(){
        ...
        FriendWishItemInfoDTO friendWishItemInfoDTO = FriendWishItemInfoDTO.builder()
